    ...
    <>
      <div className="mt-10 mx-4 md:mx-0 bg-gray-100">
        ...
        <div className='grid md:grid-cols-2 grid-cols-1'>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-1 gap-10 text-black">
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    name="user_name"
                    id="user_name"
                    className="w-full mt-2 p-3 border bg-white border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-600"
