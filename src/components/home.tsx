  ...
  return (
    <>
      ...
      <div className="mt-20">
        ...
        <p>Rotaract Club of Kirinyaga University was Chartered 10 years ago and continues to grow its membership. Our main goal being to execute Rotary International’s objectives in our world’s most persistent issues.</p>
        <p className="text-center mt-10"><Link to="/our-history"><a className="text-center rounded-md text-blue-600 border-2 border-orange-500 p-1 text-xl hover:bg-pink-600 hover:text-white"> Learn more</a></Link></p>
      </div>
      {/* our mission vission and moto */}
      <div className="mt-20 grid grid-cols-3 gap-11 w-1vh text-center">
      ...
      <div className="grid grid-cols-3 mt-10 gap-5 rounded-md">
        {courses && courses.map((course: any) => (
          <div key={course.id} className="cursor-pointer text-center relative hover:bottom-2 hover:shadow-xl hover:shadow-black">
            ...
            <button className="text-blue-500 mt-10 cursor-pointer">Learnmore</button>
          </div>
        ))}
      </div>
